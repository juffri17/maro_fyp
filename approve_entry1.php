...
if(isset($_POST['id'])) {
    ...
    $update_query = "UPDATE form2a SET approval_status = 3 WHERE id = '$id'";
    ...
    if(mysqli_query($conn, $update_query)) {
        ...
        if($email_result && mysqli_num_rows($email_result) > 0) {
            ...
            $mail->setFrom('dineshegas@outlook.com', 'Audio Visual Approval Notification');
            $mail->addAddress($email);

            $mail->isHTML(true);
            $mail->Subject = "Request Approval Notification";
            $mail->Body = "<p>Dear user (IC: $ic), your Audio Visual request has been approved.</p>";
