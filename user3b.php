...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_SESSION['ic'], $_SESSION['email'], $_POST['nama_acara'], $_POST['tarikh_acara'], $_POST['masa_acara'])) {
        $ic = $_SESSION['ic'];
        ...
        $query = "INSERT INTO form3b (ic, email, nama_acara, lokasi_acara, tarikh_acara, masa_acara) 
        ...
        if (mysqli_query($conn, $query)) {
            ...
            echo "<script>window.location.replace('user4b.php');</script>";
        } else {
...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="buttons">
            <a href="user2b.php" class="previous-button">Previous</a>
